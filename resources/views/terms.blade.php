...
<ul class="text-white">
    <li class="text-white">Modify or copy the materials</li>
    <li class="text-white">use the materials for any commercial purpose, or for any public display (commercial or non-commercial)</li>
    <li class="text-white">attempt to decompile or reverse engineer any software contained on Company's web site</li>
    <li class="text-white">iv.	remove any copyright or other proprietary notations from the materials; or
